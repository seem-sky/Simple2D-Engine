...
bool Collision::CheckTileCollision(Unit* pWho, Point<int> oldPos, Point<int> newPos, Point<int> &result)
{
    if (!pWho)
        return true;
...
bool Collision::CheckObjectCollision(Unit* pWho, Point<int> oldPos, Point<int> newPos, Point<int> &result)
{
    if (!pWho)
        return true;
