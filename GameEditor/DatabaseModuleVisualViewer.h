...
public:
    ...
    inline database::prototype::WorldObject::VisualType getVisualType() const { return m_pVisualViewer->getVisualType(); }

    void setAnimation(uint32 ID, database::prototype::WorldObject::VisualType type);
